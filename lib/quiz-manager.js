...
class QuizManager {
        ...
        try {
            ...
            for (const quiz of index.quizzes) {
                try {
                    ...
                    console.warn(`Skipping quiz ${quiz.source_file} in index generation:`, error.message);
                }
            }
            ...
            console.error('Error generating all questions index:', error);
            throw error;
        }
    }
    ...
    async getQuestionById(quizId, questionId) {
        ...
        return {
            ...
            question: this.sanitizeQuestion(question, false)
        };
    }
    ...
    async getQuizWithAnswers(quizId, questionId) {
        ...
        return {
            ...
            question: this.sanitizeQuestion(question, true)
        };
    }
    ...
    async getQuestionsInRange(filename, start, end) {
        ...
        return {
            ...
            questions: questions.map(q => this.sanitizeQuestion(q, false)),
